...
video.recorder.type=FFMPEG              // default MONTE
video.save.mode=ALL               // default FAILED_ONLY
video.frame.rate=1                // default 24
video.ffmpeg.format=x11grab             // default value depends on OS platform
video.ffmpeg.display=:0.0               // default value depends on OS platform
video.ffmpeg.pixelFormat=yuv444p        // default yuv420p (for Apple QuickTime player compatibility)
----
...
----
 mvn test -Dvideo.folder=custom_folder // default video
          ...
          -Dvideo.recorder.type=FFMPEG       // default MONTE
          -Dvideo.save.mode=ALL        // default FAILED_ONLY
          -Dvideo.frame.rate=1         // default 24
          -Dvideo.screen.size=1024x768 // custom screen size
          -Dvideo.ffmpeg.display=:1.0+10,20  // custom display configuration for ffmpeg
          -Dvideo.ffmpeg.pixelFormat=yuv444p // default yuv420p
----
...
import static TestNGRemoteListenerTest.startGrid;
...
public class IntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        System.setProperty("video.remote.hub", nodeIp);
    }
